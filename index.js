...
banChats = false;
offline = false;
targetpc = "6283824682542";
gopay = "0838-2468-2542";
limitawal = "9999999"
ovo = "0838-2468-2542";
pulsa = "0838-2468-2542";
dana = "0838-2468-2542"
namabot = "*Ditz-Bot*";
linkimg = "https://f.top4top.io/p_21276ow950.jpg";
/*ITU YG DI ATAS LINK IMAGENYA DONASI DANA YA KAWAN*/
grupct = "https://chat.whatsapp.com/FKPHOJUXS0FFlozfjcNl8A";
owner = "6283824682542";
nama_owner = "DitzXd";
instagram = "callme.ditz1";
yt = "https://www.youtube.com/channel/UCqHCAbgt7jSR4zim0om9m9w";
fake = "*DITZ - BOT*";
  ...
  try {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "6283824682542@s.whatsapp.net";
...
`;
        sendButImage(from, menu, "by @callme.ditz1 ❤️", thumb, [
          {
            ...
            type: 1,
                    ...
                    {
            buttonId: `${prefix}scditzbot`,
            buttonText: {
              displayText: `ScDitzBot`,
            },
            type: 1,
          },
        ]);
      ...
      case "owner":
        ...
        sendButMessage(
          ...
          [
            ...
            {
              buttonId: `${prefix}igstalk callme.ditz1`,
              buttonText: {
...
case "tod":
  if (isBanned) return reply(mess.ban)
					...
					sendButImage(from, arasyagans, "Case By @callme.ditz1_", thumb, [
          {
...
case 'fftext': 				
				...
				syaa.sendMessage(from, dapuhy, image, { quoted: mek, caption: 'Nih Jangan Lupa Follow Ig callme.ditz1' })
				break
case 'kbbi':	
...
case "suit":
  if (isBanned) return reply(mess.ban)
  sendButMessage(from, `Pilih Gunting Kertas Atau Batu`, `case By @callme.ditz1`, [
          {
...
Silahkan pilih, apakah kamu mau aku kirim virtex?`, `Virtex By @callme.ditz1`, [
          {
...
case "report":
                    ...
                    syaa.sendMessage('6283824682542@s.whatsapp.net', options, text, {quoted: mek})
...
break
					case "narutopekok":
					  if (args.length == 0) return reply(`Usage: ${prefix + command} text\nExample: ${prefix}coffecup Ditz`)
                    babi = args.join(" ")
                    reply("wait")
                    buffer = await getBuffer(`https://hardianto-chan.herokuapp.com/api/photooxy/coffe-cup?apikey=hardianto&text=${babi}`)
                    syaa.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan lupa follow ig @callme.ditz1', quoted: mek})
                break
case "attp":
  if (isBanned) return reply(mess.ban)
...
case 'donat':
  ...
  ├─ ❏ 083824682542
  ├─ ❏ *INSTAGRAM*
  └─ ❏ https://www.instagram.com/@callme.ditz1`)
...
case "truth":
  if (isBanned) return reply(mess.ban)
					...
					sendButImage(from, ttrth, "Case By @callme.ditz1_\nmau lagi? tekan tombol di bawah", thumb, [
          {
		...
		case "dare":
		  if (isBanned) return reply(mess.ban)
					...
					sendButImage(from, der, "Case By @callme.ditz1_\nmau lagi? tekan tombol di bawah", thumb, [
          {
            buttonId: `${prefix}dare`,
            buttonText: {
              displayText: `Dare😆`,
...
• ${prefix}fitnah
• ${prefix}fitnahpc
• ${prefix}kontak 62838246825428|Ditz
• ${prefix}jadian
• ${prefix}
• ${prefix}tod
• ${prefix}truth
...
case "peraturan2":
					...
					syaa.sendMessage(from, sya, image, { quoted: mek, caption: `Ditz Bot merupakan suatu program bot whatsapp, yang menggunakan engine nodejs v14.x.x
Adapun ketentuan untuk memakai Ditz Bot. :
...
case "textburn":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}textburn Ditz`)
				reply('Bentar lagi di proses')
...
case "quote":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}quote Ditz`)
				reply('Bentar lagi di proses')
kontol = body.slice(7)
...
case "wooden":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}wooden Ditz`)
				reply('Bentar lagi di proses')
kontol = body.slice(8)
...
case "roses":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}roses Ditz`)
				reply('Bentar lagi di proses')
kontol = body.slice(7)
...
case "naruto2":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix + command} Ditz Ganz`)
				reply('Bentar lagi di proses')
...
case "pubglogo":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}pubglogo Ditz|Ganz`)
...
case "waifum":
     ...
     break
case "ctahta":
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}ctahta Ditz|Ganteng|`)
				reply('Sebentar lagi di buat')
     ct = body.slice(9)
     memek1 = ct.split("|")[0];
     memek2 = ct.split("|")[1];
...
case "hartatahta":
         ...
         break   
case "pppppp":
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}glitch Ditz|Ganz`)
				reply('Sebentar lagi di buat')
     ct = body.slice(8)
     memek1 = ct.split("|")[0];
     memek2 = ct.split("|")[1];
...
*Model* : ${i.phone.device_model}\n\n`;
      ...
      case "grup":
        ...
        break;
        case "scjojobot":
        reply(`https://www.youtube.com/channel/UCqHCAbgt7jSR4zim0om9m9w\n\nScript nya ada di dalam video itu`)
        break
...
case 'tiktokvid':
    ...
    Follower: ${i.result.stats.followerCount}`;
     ...
     /* case "waifu":
      ...
      case "aeshtetic":
      case "wallpaperanime":
        sendButMessage(from, `Random Image by @callme.ditz1`, `press the button below`, [
          {
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`;
      ...
      case "colong":
        ...
        dua = typeof anu[1] !== "undefined" ? anu[1] : `@callme.ditz1`;
...
${
  descOwner
    ...
    : "*Desc diubah oleh* : -"
        ...
        break
if (budy.startsWith('@6283824682542')){
